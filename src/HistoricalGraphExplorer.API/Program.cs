...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new()
    {
        ...
        Version     = "v1",
        Description = "Query 780 historical events using graph traversal or natural language AI with conversational memory."
    });
...
// Conversation store — singleton so session state persists across requests
// Swap InMemoryConversationStore for a Redis implementation in production
...
app.MapGet("/health", async (IGremlinRepository repo) =>
{
